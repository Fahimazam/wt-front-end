...
<head>
	...
	<link rel="stylesheet" href="/static/css/general_login_form.css">
...
<body>
	<div class="container">
		...
		<form action="#" class="login1">
			...
			<button type="submit" class="btn-submit"><a class="txt" href="admin.html">Login</a></button>
		...
		<form action="#" class="login2">
			...
			<button type="submit" class="btn-submit"><a class="txt" href="dashboard.html">Login</a></button>
			<a href="#">Forgot password?</a>
			<p>I don't have an account. <a href="#" onclick="switchForm('register', event)">Register</a></p>
		</form>
