...
<head>
    ...
    <link rel="stylesheet" href="/static/css/landing_1.css">
</head>
<body class="hudai">
    <nav class="navbar">
            ...
            <div class="service-banner">
                <div class="service-box s1">
                    <div class="service-image img1">
                        <img src="/static/img/Frame 3.png" alt="">
                    </div>
                ...
                <div class="service-box s2">
                    <div class="service-image img2">
                        <img src="/static/img/lost.jpg" alt="">
                    </div>
                    <div class="content-box">
                        <h3>02.Lost & Found</h3>
                ...
                <div class="service-box s3">
                    <div class="service-image img3">
                        <img src="/static/img/help.jpg" alt="">
                    </div>
                    <div class="content-box">
    ...
    <!-- .............................. card ................................ -->
        ...
        <Section id="Forth">
            ...
            <div class="form-banner reverse-col">
                ...
                <div class="form-image">
                    <img src="/static/img/lost_found_post.png" alt="">
                </div>
            </div>
